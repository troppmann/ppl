  ...
  testGroup
    ...
    [ testGroup
        ...
        [ testInterpretExprEq "Uniform" (VFloat 0.5) (1, 1.0),
          ...
          testInterpretExprEq "Uniform" (VFloat 1.0) (1, 0.0),
          ...
          testInterpretExprEq "Uniform * 5" (VFloat 4.8) (1, 0.2),
          ...
          testInterpretExprEq "if Uniform < 0.5 then (Uniform, 2.0) else (Normal, 3.0)" (VTuple (VFloat 0.9) (VFloat 2.0)) (1, 0.5),
      ...
      testGroup
        "Dimension:"
        [ testInterpretExprEq "(Uniform, Uniform)" (VTuple (VFloat 0.4) (VFloat 0.1)) (2, 1.0),
          ...
          testInterpretExprEq "(Uniform, Normal, Uniform < 0.5)" (VTuple (VFloat 0.1) (VTuple (VFloat 0.0) (VBool True))) (2, 0.3989 * 0.5),
          testInterpretExprEq "((Uniform, Normal), Uniform < 0.5)" (VTuple (VTuple (VFloat 0.1) (VFloat 0.0)) (VBool True)) (2, 0.3989 * 0.5),
