...
tests =
  testGroup
    ...
    [ testDimProbWithName "(0, 0.5 + 0.5)" (0, 0.5 + 0.5) (0, 1.0),
      ...
      testDimProbWithName "(2, 1.0) #-# (1, 0.3)" ((2, 1.0) #-# (1, 0.0)) (2, 1.0),
      testDimProbWithName "(1, 0.0) #-# (2, 0.4)" ((1, 0.0) #-# (2, 0.4)) (2, 0.0),
      testDimProbWithName "(1, 0.7) #-# (1, 0.4)" ((1, 0.4) #-# (1, 0.7)) (1, 0.0),
      testDimProbWithName "(0, 1.0) #-# ((0, 1.0) #-# (0, 0.3))" ((0, 1.0) #-# ((0, 1.0) #-# (0, 0.3))) (0, 0.3),
      testDimProbWithName "Vanishing PDF:(0, 1.0) #-# ((0, 1.0) #-# (1, 0.3))" ((0, 1.0) #-# ((0, 1.0) #-# (1, 0.3))) (0, 0.0)
    ]