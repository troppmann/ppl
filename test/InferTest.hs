    ...
    [ testGroup
      ...
      testGroup
        ...
        [ testInferProgram "main = 2 + 2" (VFloat 4.0) (0, 1.0),
          ...
          testInferProgram "main = replicate 1 Uniform; replicate n value = if n <= 1 then value else (value, replicate (n-1) value);" (VFloat 3.0) (1, 0.0),
          ...
          testInferProgram "main = dice 40;dice n = if n <= 1 then 1 else ( if Uniform < (1/n) then n else dice (n-1));" (VFloat 20) (0, 1.0/40.0),
          ...
          testInferProgram "main = tMid (tIn);tIn = 1; tMid x = (x,x)" (VTuple (VFloat 1.0) (VFloat 1.0)) (0, 1.0),
